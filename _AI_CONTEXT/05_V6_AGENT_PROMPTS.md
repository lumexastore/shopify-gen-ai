...
2) Извлеки текст:
   - heading: ближайший `h1/h2` по nodes и по визуалу
   - subheading/body/bullets: из `p/li`
3) Найди CTA:
...
Правило: если ты не уверен в тексте — поставь `null`, но добавь в `problems[]` причину.
